...
from apps.asets.models import TanggulSungaiModel, FotoTanggulSungaiModel
from apps.asets.forms import (
    FotoTanggulSungaiForm,
    TanggulSungaiForm,
    UploadExcelFormTanggul,
)
...
def index(request):
    ...
    context = {
        "filename": "tsungai",
        "objects": objects,
        "form": UploadExcelFormTanggul(),
    }

    return render(request, "tanggul/index_tsungai.html", context)
...
def create(request: HttpRequest):
    ...
    return render(request, "tanggul/add_tsungai.html", context)
...
def detail(request: HttpRequest, id):
    ...
    return render(request, "tanggul/detail_tsungai.html", context)
...
def update(request: HttpRequest, id):
    ...
    context = {"filename": "tsungai", "form": form}
    return render(request, "tanggul/edit_tsungai.html", context)
...
def import_template(request: HttpRequest):
    if request.method == "POST":
        form = UploadExcelFormTanggul(request.POST, request.FILES)
