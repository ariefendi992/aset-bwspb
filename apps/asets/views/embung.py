...
from apps.asets.forms import EmbungForms, UploadExcelFormEmbung
...
def index_embung(request):
    ...
    context = {
        "filename": "embung",
        "data": obj,
        "form": UploadExcelFormEmbung(),
    }
    return render(request, "embung/index_embung.html", context)
...
def add_embung(request: HttpRequest):
    ...
    return render(request, "embung/add_embung.html", context)
...
def detail_embung(request: HttpRequest, id):
    ...
    return render(request, "embung/detail_embung.html", context)
...
def update_embung(request: HttpRequest, id):
    ...
    return render(request, "embung/edit_embung.html", context)
...
def import_excel(request: HttpRequest):
    if request.method == "POST":
        form = UploadExcelFormEmbung(request.POST, request.FILES)
    ...
    return render(request, "embung/index_danau.html", context)
