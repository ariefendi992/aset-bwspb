...
from apps.asets.models import FotoBendungModel, BendungModel
from apps.asets.forms import BendungForms, FotoBendungFormSet, UploadExcelFormBendung
...
def index_bendung(request):
    ...
    context = {
        "filename": "bendung",
        "objects": obj,
        "form": UploadExcelFormBendung(),
    }
    return render(request, "bendung/index_bendung.html", context)
...
def add_bendung(request: HttpRequest):
    ...
    return render(request, "bendung/add_bendung.html", context)
...
def update_bendung(request: HttpRequest, id):
    ...
    return render(request, "bendung/edit_bendung.html", context)
...
def detail_bendung(request: HttpRequest, id):
    ...
    return render(request, "bendung/detail_bendung.html", context)
...
def import_excel(request: HttpRequest):
    if request.method == "POST":
        form = UploadExcelFormBendung(request.POST, request.FILES)
