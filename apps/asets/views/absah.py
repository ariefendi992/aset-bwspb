...
from apps.asets.forms import AbsahForm, UploadExcelFormAbsah
...
def index(request: HttpRequest):
    ...
    context = {"filename": "absah", "objects": objects, "form": UploadExcelFormAbsah()}

    return render(request, "absah/index_absah.html", context)
...
def create(request: HttpRequest):
    ...
    return render(request, "absah/add_absah.html", context)
...
def update(request: HttpRequest, id):
    ...
    return render(request, "absah/edit_absah.html", context)
...
def detail(request: HttpRequest, id):
    ...
    return render(request, "absah/detail_absah.html", context)
...
def import_template(request: HttpRequest):
    if request.method == "POST":
        form = UploadExcelFormAbsah(request.POST, request.FILES)
