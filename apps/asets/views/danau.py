...
from apps.asets.forms import DanauForms, UploadExcelFormDanau
...
def index_danau(request):
    ...
    return render(request, "danau/index_danau.html", context)
...
def detail_danau(request, id):
    ...
    return render(request, "danau/detail_danau.html", context)
...
def add_danau(request: HttpRequest):
    ...
    return render(request, "danau/add_danau.html", context)
...
def update_danau(request: HttpRequest, id):
    ...
    return render(request, "danau/edit_danau.html", context)
...
def import_excel(request: HttpRequest):
    if request.method == "POST":
        form = UploadExcelFormDanau(request.POST, request.FILES)
